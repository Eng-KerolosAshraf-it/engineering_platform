...
class SupervisionForm extends StatefulWidget {
  ...
  @override
  State<SupervisionForm> createState() => _SupervisionFormState();
}
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                FormSection(
                  title: AppTranslations.get('proj_status_service', lang),
                  children: [
                    ServiceTypeButton(
                      label: AppTranslations.get('supervision', lang),
                      isSelected: true,
                    ),
                    const SizedBox(height: 32),
                    Text(
                      AppTranslations.get('existing_proj_dev', lang),
                    ...
                    FormRow(
                      children: [
                        RadioOption(
                          label: AppTranslations.get('yes_existing_proj', lang),
                          isSelected: isExistingProject,
                          onTap: () => setState(() => isExistingProject = true),
                        ),
                        const SizedBox(width: 24),
                        RadioOption(
                          label: AppTranslations.get('no_new_proj', lang),
                          isSelected: !isExistingProject,
                          onTap: () =>
                              setState(() => isExistingProject = false),
                        ),
                      ],
                    ),
